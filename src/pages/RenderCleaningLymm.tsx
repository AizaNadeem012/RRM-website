...
export default function RenderCleaningLymm() {
  const renderTypes = [
    "Smooth or painted render",
    "Pebbledash / roughcast render",
    "Monocouche or acrylic render",
  ...
  const contaminants = [
    ...
    "Mould and lichen",
    "Dirt and grime",
    "Pollution stains and black streaks"
  ];

  const benefits = [
    "Restores walls' appearance and colour",
    "Removes moss, algae, mould, and dirt",
  ...
  const whyChooseUs = [
    "Local render cleaning experts in Lymm",
  ...
  return (
    <Layout>
      <Helmet>
        <title>Render Cleaning Lymm | R.R.M External Cleaning Specialist</title>
        <meta 
          name="description" 
          content="Expert render cleaning in Lymm. Remove moss, algae, mould & dirt safely with R.R.M External Cleaning Specialist. Call +44 7845 463877 for a free quote today." 
        />
        <link rel="canonical" href="https://rrmcleaning.co.uk/render-cleaning-lymm" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-primary-foreground/90 mb-10 max-w-3xl mx-auto animate-fade-up stagger-1 leading-relaxed">
              Professional Render Cleaning Services by R.R.M External Cleaning Specialist
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-muted-foreground mb-6 animate-fade-in leading-relaxed">
              Maintaining a clean exterior is essential for protecting your property and enhancing its appearance. In Lymm, 
              changing weather conditions and local environmental factors can lead to moss, algae, dirt, and pollution stains 
              on rendered walls. Professional render cleaning ensures your property remains attractive, safe, and structurally sound.
            </p>
            <p className="text-lg text-muted-foreground animate-fade-in stagger-1 leading-relaxed">
              R.R.M External Cleaning Specialist provides expert render cleaning in Lymm and surrounding areas, using safe 
              soft washing techniques, eco-friendly solutions, and specialist expertise suitable for all types of render.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 text-center animate-fade-up">
              Render Cleaning Services in Lymm
            </h2>
            <p className="text-lg text-muted-foreground mb-6 text-center max-w-3xl mx-auto animate-fade-up stagger-1">
              Rendered surfaces are constantly exposed to rain, pollution, and damp conditions, which can lead to algae, 
              moss, mould, and dirt build-up. These issues not only affect the visual appeal of your property but can also 
              compromise the render's integrity over time.
            </p>
            <p className="text-lg text-muted-foreground text-center max-w-3xl mx-auto animate-fade-up stagger-2">
              Our render cleaning service removes contaminants safely and effectively, restoring walls to their original look 
              and protecting them against long-term damage.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 animate-fade-up">
              What Is Render Cleaning & Why It's Needed in Lymm
            </h2>
            <p className="text-lg text-muted-foreground mb-6 animate-fade-up stagger-1">
              Render cleaning involves the removal of:
            </p>
            ...
            <p className="text-lg text-muted-foreground mb-4 animate-fade-up">
              In Lymm, the damp climate and shaded areas make properties particularly prone to algae and moss growth. Regular cleaning:
            </p>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { icon: Shield, text: "Protects render from deterioration" },
                { icon: AlertTriangle, text: "Prevents staining and structural damage" },
                { icon: Home, text: "Maintains the aesthetic appeal of residential and commercial properties" }
              ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8 text-center animate-fade-up stagger-1">
              We clean all types of render commonly found in Lymm properties, including:
            </p>
              ...
              {[
                {
                  ...
                  desc: "We inspect the render type, level of contamination, and accessibility to determine the appropriate cleaning method."
                },
                {
                  step: 2,
                  title: "Preparation",
                  desc: "Plants, windows, and other surrounding areas are protected before cleaning begins."
                },
                {
                  step: 3,
                  title: "Soft Wash Application",
                  desc: "We apply a low-pressure soft wash solution that eliminates moss, algae, mould, and grime without damaging the render."
                },
                {
                  step: 4,
                  title: "Controlled Rinse",
                  desc: "The treated surfaces are rinsed carefully to remove residues and achieve an even clean finish."
                },
                {
                  step: 5,
                  title: "Protective Treatment",
                  desc: "We can apply a protective coating to prevent regrowth and maintain cleanliness longer."
                }
              ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-6">
              <div className="bg-card rounded-xl p-8 border-2 border-green-200 card-shadow hover-lift feature-card animate-slide-left">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Removes moss, algae, mould at the root",
              ...
              <div className="bg-card rounded-xl p-8 border-2 border-red-200 card-shadow hover-lift feature-card animate-slide-right">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-foreground">High Pressure Avoided</h3>
                </div>
                <p className="text-muted-foreground mb-4">Why high-pressure washing is avoided:</p>
                <ul className="space-y-3">
                  {["Can erode render and paint", "Damages textured surfaces", "May lead to water ingress"].map((item, index) => (
                    <li key={index} className="flex items-start gap-3">
            ...
            <p className="text-center text-lg text-foreground font-medium animate-fade-up">
              We prioritise safety, surface protection, and long-term results for every property.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <div className="bg-card rounded-xl p-8 border-2 border-primary/20 card-shadow hover-lift feature-card animate-slide-left">
                <h3 className="text-2xl font-bold text-foreground mb-4 flex items-center gap-3">
                  ...
                  Residential Render Cleaning in Lymm
                </h3>
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    "Terraced homes and cottages",
                    "Flats and townhouses",
                    "New-build and older heritage properties"
                  ].map((item, index) => (
                ...
                <p className="text-muted-foreground mt-4">
                  Our services can be one-off cleans or part of a regular maintenance plan.
                </p>
              </div>
              ...
              <div className="bg-card rounded-xl p-8 border-2 border-accent/20 card-shadow hover-lift feature-card animate-slide-right">
                ...
                <p className="text-muted-foreground mb-4">
                  Our commercial services cater to:
                </p>
                <ul className="space-y-2">
                  {[
                ...
                <p className="text-muted-foreground mt-4">
                  All commercial work is fully insured and complies with UK health & safety standards.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 text-center animate-fade-up">
              Render Cleaning Prices in Lymm
            </h2>
            ...
            <div className="bg-gradient-to-br from-card to-muted/30 rounded-2xl p-8 border-2 border-primary/10 card-shadow animate-scale-in">
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                {[
                  { label: "Small residential property", price: "£150 – £300" },
                  { label: "Medium property", price: "£300 – £500" },
                  { label: "Large or commercial properties", price: "£500 – £800" }
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                "Protection for plants, windows, and surrounding areas",
                "Safe management of water runoff",
                "Biodegradable and eco-friendly cleaning chemicals",
                "Full compliance with UK health & safety standards"
              ].map((practice, index) => (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                ...
                {
                  q: "Is render cleaning safe for all surfaces?",
                  a: "Yes, soft wash methods are safe for smooth, textured, painted, and pebbledash render."
                },
                {
                  q: "Can algae and moss be removed from painted render?",
                  a: "Yes, using specialist low-pressure cleaning solutions."
                },
                {
                  q: "Do you provide commercial render cleaning?",
                  a: "Yes, for both residential and commercial properties in Lymm."
                },
                {
                  q: "How long do results last?",
                  a: "With optional protective treatments, results can last several years."
                }
              ].map((faq, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-6 text-center animate-fade-up stagger-1">
              In addition to Lymm, we serve surrounding areas including:
            </p>
      ...
      <section className="relative py-16 md:py-20 bg-secondary overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold text-secondary-foreground mb-4 animate-fade-up">
            Book Render Cleaning in Lymm
          </h2>
          <p className="text-lg text-secondary-foreground/80 mb-8 max-w-2xl mx-auto animate-fade-up stagger-1">
            For professional, safe, and effective render cleaning in Lymm, contact R.R.M External Cleaning Specialist today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-up stagger-2">
            <Button size="xl" className="hover-lift group" asChild>
              <a href="tel:+447845463877" className="flex items-center gap-2">
